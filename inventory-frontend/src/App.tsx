        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex gap-4">
              <Link to="/gallery" className="hover:bg-indigo-600 px-3 py-2 rounded-md font-medium transition-colors">
                Gallery
              </Link>
              <Link to="/admin" className="hover:bg-indigo-600 px-3 py-2 rounded-md font-medium transition-colors">
                Admin Dashboard
              </Link>
            </div>
          </div>
